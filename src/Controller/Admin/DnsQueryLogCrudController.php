 ...
 * DNS查询日志管理控制器
 *
 * @extends AbstractCrudController<DnsQueryLog>
 */
#[AdminCrud(routePath: '/dns/query-log', routeName: 'dns_query_log')]
final class DnsQueryLogCrudController extends AbstractCrudController
{
