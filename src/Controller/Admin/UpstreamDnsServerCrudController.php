 ...
 * 上游DNS服务器管理控制器
 *
 * @extends AbstractCrudController<UpstreamDnsServer>
 */
#[AdminCrud(routePath: '/dns/upstream-server', routeName: 'dns_upstream_server')]
final class UpstreamDnsServerCrudController extends AbstractCrudController
{
